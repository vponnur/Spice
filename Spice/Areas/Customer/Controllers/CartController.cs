...
namespace Spice.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public async Task<IActionResult> SummaryPost(string stripeToken)
        {
            ...
            {
                //Sending Email
                string email = _db.Users.Where(u => u.Id == claim.Value).FirstOrDefault().Email;
                string subject = "Spice - Order was Created. Order ID : " + detailCart.OrderHeader.Id;
                string msgOrderStatus = "Order has been submitted successfully.";
